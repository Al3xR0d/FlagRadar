...
interface CreateCTFModalProps extends ModalBaseProps {}
...
> = {
  ...
  ref_rules: {
    label: 'Правила CTF',
    requiredMessage: 'Введите правила CTF',
...
export const CreateCTFModal: React.FC<CreateCTFModalProps> = ({ open, onClose }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log('дата:', formatedValues);
  ...
  return (
    <Modal
      ...
      destroyOnHidden
      // okButtonProps={{
      //   style: { backgroundColor: '#00FF9D', color: '#0e0e14' },
      // }}
      // cancelButtonProps={{
      //   style: { color: '#e0e0ff', backgroundColor: '#151522', border: '1px solid #25253a' },
      // }}
      footer={[
        <>
