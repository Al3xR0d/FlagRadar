...
FlagRadar — веб-приложение для управления CTF-событиями, командами и рейтингами, построенное на современных технологиях для удобного интерфейса и взаимодействия с API.
